...
int main()
{
    ...
    cin>>coins[i];
    dp[0]=1;
    /* In coin combination-1, we will the outer loop running from 1 to sum. In coin combination-2 we have the inner 
    loop running from 1 to sum. Rest everything is same.
